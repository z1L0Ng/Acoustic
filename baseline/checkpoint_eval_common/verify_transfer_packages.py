...
COMMON_FILES = [
    "baseline/checkpoint_eval_common/__init__.py",
    "baseline/checkpoint_eval_common/sprsound_inter.py",
    "baseline/checkpoint_eval_common/verify_sprsound_inter_contract.py",
    "baseline/checkpoint_eval_common/verify_transfer_packages.py",
]
METHOD_FILES = {
    "pafa": [

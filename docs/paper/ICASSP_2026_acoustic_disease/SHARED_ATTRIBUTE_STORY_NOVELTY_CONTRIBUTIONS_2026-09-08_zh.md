...
[^14]: **此前的问题与实现定位。** [已有深度定位稿](/Users/zilongzeng/.codex/worktrees/8ad2/Acoustic/docs/paper/ICASSP_2026_acoustic_disease/DEEP_NOVELTY_GAP_REVIEW_2026-09-08_zh.md)，§4.2、§6；监督差异同时由当前映射与方法定义核对。

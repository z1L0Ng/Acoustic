# Acoustic End-to-End Pipeline v2.6 — Companion Specification

## 0. Purpose and scope

This document is the audit-oriented companion to:

- `figures/pipeline/acoustic_end_to_end_pipeline_v2.6.svg`
- `figures/pipeline/acoustic_end_to_end_pipeline_v2.6.png`
...
This Markdown contains information deliberately removed from the main figure: complete dataset facts, support counts, tensor contracts, architecture limits, training/comparison controls, evidence boundaries, operational status and open decisions.
